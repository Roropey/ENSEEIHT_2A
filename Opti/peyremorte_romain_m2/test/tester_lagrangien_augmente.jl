...
function tester_lagrangien_augmente(afficher::Bool,Lagrangien_Augmente::Function)
	...
	@testset "Lagrangien augmenté  " begin 					
		@testset "Avec $algo" for algo in algos									
			# le cas de test 1
			xmin,fxmin,flag,nbiters,_,_ = Lagrangien_Augmente(algo,fct1,contrainte1,grad_fct1,hess_fct1,grad_contrainte1,
			...
			# le cas de test 3
			xmin,fxmin,flag,nbiters,_,_ = Lagrangien_Augmente(algo,fct2,contrainte2,grad_fct2,hess_fct2,grad_contrainte2,
